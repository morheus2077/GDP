  ...
  function App() {
    ...
    const[Despesa, setDespesa] = useState <Despesas[]>([])
      ...
      // Validação do valor
      if(!valor){
        setErroValor("Por favor, insira um valor.");
        return;
      }
      ...
      if (!categoria) {
        setErroCategoria('Por favor, selecione uma categoria.');
        return;
      }
    ...
    return (
      <>
        <section className='bg-[#f9fafb] h-screen'>
          ...
          <div className='cds flex-col lg:flex-row md:flex items-center lg:gap-8 justify-center mt-8'>
            ...
            <div className='bg-white border border-gray-300 mx-3 lg:w-96 md:w-3xl h-32 md:h-36 lg:h-36 rounded-lg'>
              <div className='flex justify-between px-5 pt-5'>
                ...
                <div className='text-green-600 transition-all duration-300 hover:text-purple-600 animate-pulse-slow'>
                  < CircleDollarSign/>
                </div>
              </div>
          ...
          {/* Area de gestao e visualizacao de despesas */}
            ...
            <div className='bg-white h-[500px] lg:h-[600px] md:h-[500px] mx-[6px] md:w-[360px] md:mx-10px] lg:w-[580px] border border-gray-300 rounded-md'>
              <div className='px-10 pt-5 lg:pt-10'>
                ...
                <div className='flex flex-col items-center justify-center mt-5'>
                  <form onSubmit={textoAtualizar.enabled ? atualizarDespesa : adicionarDespesa}>
                    <div className='lg:mr-[180px]'>
                      ...
                      />
                      <p className='text-red-600 text-xs'>{erroNome}</p>
                    </div>
                    <div className="flex gap-5 mt-3">
                      ...
                      />
                        <p className='text-red-600 text-xs'>{erroValor}</p>
                        </div>
                      </div>
                      <div>
                        ...
                        required
                        value={data}
                        onChange={(e)=>{setdata(e.target.value); setErroData('')}}
                        /></div>
                        <p className='text-red-600 text-xs'>{erroData}</p>
                      </div>
                    </div>
                    <div className='flex flex-col mt-5'>
                      ...
                      onChange={(e) => {
                        ...
                        setErroCategoria(''); // Limpa o erro ao selecionar uma categoria
                      }}
                      >
                    ...
                    <div>
                      ...
                      <button type='submit' className='bg-black text-white border-gray-300 w-[340px] lg:w-[500px] h-10 rounded-md indent-1 mt-5 cursor-pointer' onClick={atualizarDespesa}>Atualizar despesa</button>
                      )}
                    </div>
                  </form>
                </div>
